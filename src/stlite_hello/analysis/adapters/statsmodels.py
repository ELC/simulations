...
def kaplan_meier_mean_lifetime(
    *,
    ...
    The mean is restricted to the largest observed duration: it is the area
    under the survival function on the observed support, which is the
    standard non-parametric estimator (also known as the restricted mean
    survival time).
    """
